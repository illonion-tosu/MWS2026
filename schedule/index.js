...
function createMatchDisplay(match) {
    ...
    matchTimeDiv.textContent = `${matchTime.toLocaleString('en-US', { weekday: 'short', timeZone: 'UTC' }).toUpperCase()} ${String(matchTime.getUTCHours()).padStart(2, "0")}:${String(matchTime.getUTCMinutes()).padStart(2, "0")} UTC`
